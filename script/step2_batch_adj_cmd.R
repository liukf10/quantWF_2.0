...
option_list = list(
  ...
  make_option("--keepvar", action="store", default=NA,
              type='character',help="keeped var column name, can be a vector, default is diagnose."),
  make_option("--batch_name", action="store", default=NA,
              type='character',help="batch column name, default is batch."),
  make_option("--ref_batch", action="store", default=NA,
              type='character',help="ref_batch, default is NULL."),
  make_option("--method", action="store", default=NA,
              type='character',help="method to remove batch effect: combat, combat_seq or limma, default is combat."),
  make_option("--evaluate_method", action="store", default=NA,
              type='character',help="evaluate the result: pca, pvca, bic and MDS, default is pvca&pca."),
...
if(is.na(opt$ref_batch)) {
  opt$ref_batch = NULL; message("Setting ref_batch as default: NULL. Only use in ComBat")}
if(is.na(opt$method)) {
